            ...
            <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form__group field">
                                        ...
                                        <label for="inp-nama-deb-personal" class="form__label"><i class="fa fa-calendar"></i> TANGGAL IDENTITAS <span class="mandatory"> *</span></label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form__group field">
                ...
                <div class="div-info-alamat">
                    ...
                    <div class="col-md-12" style="margin-top:10px">
                        <table id="tbl-informasi-alamat-personal" class="table table-bordered table-hover dt-responsive display center-td center-td">
                            <thead>
                                <tr>
                                    <th>Alamat Tagih</th>
                                    <th>Jenis Alamat</th>
                ...
                <div class="div-emergency-contact">
                    ...
                    <div class="col-md-12" style="margin-top:10px">
                        <table id="tbl-emergency-contact-personal" class="table table-bordered table-hover dt-responsive display center-td center-td">
                            <thead>
                                <tr>
                                    <th>Nama</th>
                ...
                <div class="div-informasi-bank">
                    ...
                    <div class="col-md-12" style="margin-top:10px">
                        <table id="tbl-informasi-bank-personal" class="table table-bordered table-hover dt-responsive display center-td center-td">
                            <thead>
                                <tr>
                                    <th>Nama Bank</th>
                                    <th>Cabang Bank</th>
                ...
                <div class="div-informasi-kartukredit">
                    ...
                    <div class="col-md-12" style="margin-top:10px">
                        <table id="tbl-informasi-kartukredit-personal" class="table table-bordered table-hover dt-responsive display center-td center-td">
                            <thead>
                                <tr>
