                ...
                <div class="card-header">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="survey" role="tabpanel" aria-labelledby="survey">
                            <?php $this->load->view('/page/detail_verifikasi_data/view_detail_aplikasi/view_subtab_detail_aplikasi/subtab_survey'); ?>
                        </div>
                        <div class="tab-pane" id="dokumen" role="tabpanel" aria-labelledby="dokumen">
                            <?php $this->load->view('/page/detail_verifikasi_data/view_detail_aplikasi/view_subtab_detail_aplikasi/subtab_dokumen'); ?>
                        </div>
                    </div>
                </div>
            </div>
