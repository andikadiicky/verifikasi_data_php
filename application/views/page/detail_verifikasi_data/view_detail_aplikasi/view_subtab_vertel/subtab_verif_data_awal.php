                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form__group field">
                                    <input id="inp-tgl-verif-awal" type="input" class="form__field datetimepicker-input tanggal inp-tanggal" data-toggle="datetimepicker">
                    ...
                    <table id="tbl-verif-data-awal" class="table table-bordered table-hover dt-responsive display center-td">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><select class="form-control select2bs4" style="width: 100%;" id="slc-sudah-terima-unit">
                                        <option>Dummy</option>
                            ...
                            <tr>
                                ...
                                <td><select class="form-control select2bs4" style="width: 100%;" id="slc-full-name">
                                        <option>Dummy</option>
                                        <option>Playful</option>
                                        <option>Lazy</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td><select class="form-control select2bs4" style="width: 100%;" id="slc-tempat-lahir">
                                        <option>Dummy</option>
                                        <option>Playful</option>
                                        <option>Lazy</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td><select class="form-control select2bs4" style="width: 100%;" id="slc-ibu-kandung">
                                        <option>Dummy</option>
                                        <option>Playful</option>
                                        <option>Lazy</option>
                                    </select>
