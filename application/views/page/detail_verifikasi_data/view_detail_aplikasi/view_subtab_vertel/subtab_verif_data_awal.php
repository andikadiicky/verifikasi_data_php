                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="form__group field">
                                <input type="text" class="form__field" placeholder="NO VERIFIKASI AWAL" id="inp-vo-verif-awal" disabled/>
                                <label for="inp-vo-verif-awal" class="form__label">NO VERIFIKASI AWAL</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form__group field">
                                <input type="text" class="form__field" placeholder="NO KONTRAK" id="inp-no-kontrak-verif" disabled/>
                        ...
                        <div class="form-group">
                            <div class="form__group field">
                                <div class="input-group flex-nowrap">
                                    <input id="inp-tgl-verif-awal" type="text" class="form__field datetimepicker-input tanggal inp-tanggal" data-toggle="datetimepicker" disabled>
                                ...
                                <label for="inp-tgl-verif-awal" class="form__label">TANGGAL <span class="mandatory"> *</span></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form__group field">
                                <div class="input-group flex-nowrap">
                                    <input id="inp-no-telp-verif" type="text" class="form__field" disabled/>
                                ...
                                <label for="inp-no-telp-verif" class="form__label">NO TELEPON <span class="mandatory"> *</span></label>
                            </div>
                        </div>
                    </div>
                </div>
