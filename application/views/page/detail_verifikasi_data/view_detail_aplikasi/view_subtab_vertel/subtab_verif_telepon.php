                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form__group field">
                                    <input id="inp-tgl-vertel" type="input" class="form__field datetimepicker-input tanggal inp-tanggal" data-toggle="datetimepicker">
                    ...
                    <table id="tbl-verifikasi-telepon" class="table table-bordered table-hover dt-responsive display center-td">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <select class="form-control select2bs4" style="width: 100%;" id="slc-merk-model">
                            ...
                            <tr>
                                ...
                                <td><select class="form-control select2bs4" style="width: 100%;" id="slc-tenor">
                                        <option selected>Ya</option>
                                    </select>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><select class="form-control select2bs4" style="width: 100%;" id="slc-angsuran">
                                        <option selected>Ya</option>
                                    </select>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="form__group field">
                                            <input id="" type="input" class="form__field datetimepicker-input tanggal inp-tanggal" data-toggle="datetimepicker" value="13-NOV-2020">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <select class="form-control select2bs4" style="width: 100%;" id="slc-row-penerima-unit">
                                        ...
                                        <div class="col-sm-12" style="margin-top: 5px;">
                                            <div class="form__group field">
                                                <input type="input" class="form__field" placeholder="" id="" disabled value="ISRAIL" />
                                            </div>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="col-md-12" style="margin-top: 10px;">
                    <div class="row">
                        <div class="col align-self-start">
                            <button type="button" class="btn btn-light">Print Form OTS</button>
