...
app.pekerjaan = {
  ...
  init: function () {
    ...
    function switchBekerja() {
      ...
      $("#label-notelp-bekerja").show();
      $("#label-notelp-usaha").hide();
    }
    function switchUsaha() {
      ...
      $("#label-notelp-bekerja").hide();
      $("#label-notelp-usaha").show();
    }
    ...
    function switchBekerjaPasangan() {
      ...
      $("#label-notelp-bekerja-pasangan").show();
      $("#label-notelp-usaha-pasangan").hide();
    }
    function switchUsahaPasangan() {
      ...
      $("#label-notelp-bekerja-pasangan").hide();
      $("#label-notelp-usaha-pasangan").show();
    }
  },
};
